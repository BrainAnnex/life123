...
PlotlyHelper.heatmap_stack_1D(data_matrix=data_matrix, 
                              labels=["A"], title="Test of 1-D heatmap stacking", 
...
# %%
PlotlyHelper.heatmap_stack_1D(data_matrix=data_matrix, 
                              labels=["A"], title="Test of 1-D heatmap stacking, color-coded but without bin borders", 
                              data_name="Conc.", entity_name="CHEM",
                              colors=["turquoise"], color_borders=False)
...
# %%
PlotlyHelper.heatmap_stack_1D(data_matrix=data_matrix, 
                              labels=["A"], title="Test of 1-D heatmap stacking with barriers at the far edges, using a different color", 
                              data_name="Conc.", entity_name="CHEM",
                              colors=["turquoise"], 
                              barriers=[0, 1, 2, 4, 9, 10], barrier_color="brown")
...
# %%
PlotlyHelper.heatmap_stack_1D(data_matrix=data_matrix, labels=["A", "B"], 
                              title="Specifying vertical grid spacing and colorbar extension", grid_vert_spacing=0.4, colorbar_extend=2)
...
# %%
PlotlyHelper.heatmap_stack_1D(data_matrix=data_matrix, labels=["A", "B"], 
                              title="Specifying vertical grid spacing and colorbar extension", grid_vert_spacing=0, colorbar_extend=1.1)

# %%
PlotlyHelper.heatmap_stack_1D(data_matrix=data_matrix, labels=["A", "B"], 
                              title="Specifying the height", height=550)

# %%
PlotlyHelper.heatmap_stack_1D(data_matrix=data_matrix, labels=["A", "B"], 
                              title="Specifying the height", height=1000)

# %%
PlotlyHelper.heatmap_stack_1D(data_matrix=data_matrix, labels=["A", "B"], colors=["turquoise", "yellow"])

# %%
PlotlyHelper.heatmap_stack_1D(data_matrix=data_matrix, labels=["A", "B"], colors=["turquoise", "yellow"], barriers=[0, 2, 4, 9])
...
PlotlyHelper.heatmap_stack_1D(data_matrix=data_matrix, labels=["A", "B", "C", "D"],
                              ...
                              barriers=[1, 2, 4, 10], barrier_color="brown")
...
PlotlyHelper.heatmap_stack_1D(data_matrix=data_matrix, labels=["A", "B", "C", "D"],
                              ...
                              data_name="Conc.", entity_name="CHEM",
                              colors=["turquoise", "yellow", "green", "pink"],
                              barriers=[1, 2, 4, 5], barrier_color="brown")
