...
#
# This is a repeat of the experiment _"react_1_a"_ , but with adaptive variable time steps
#
...
dynamics.set_adaptive_parameters(preset="mid")   # A "middle-of-the road" heuristic: somewhat "conservative" but not overly so
...
# %% [markdown]
# #### Compare the above with the fixed step sizes of experiment `react_1`    
