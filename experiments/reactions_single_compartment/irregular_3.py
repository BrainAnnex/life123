...
# %%
dynamics.single_compartment_react(time_step=0.001, stop_time=0.1,
                                  dynamic_steps=8, abs_fast_threshold=10)   # Same as fast_threshold=1

# %%
dynamics.single_compartment_react(time_step=0.01, stop_time=8.0,
                                  dynamic_steps=8, abs_fast_threshold=40)  # Using abs_fast_threshold here
...
# %%
dynamics.is_in_equilibrium(tolerance=0.5)
