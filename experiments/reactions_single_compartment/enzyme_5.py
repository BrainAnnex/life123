...
#
# ## Enzyme Kinetics in a Michaelis-Menten modality
...
# ### Unlike in experiment `enzyme_4`, this time We'll comply with the customary Michaelis-Menten assumptions that `[E] << [S]` and that the rates satisfy `k1_reverse >> k2_forward` !   
# #### We'll explore ...

# %%
LAST_REVISED = "July 11, 2024"
