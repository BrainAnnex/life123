...
conc_list=[10,13,17,21,25,28,30,32,35,36,39,37,35,32,27,23,20,17,14,8,3,10,16,18,
           20,25,30,35,40,50,60,85,110,92,73,69,65,58,52,46,40,45,50,55,60,62,65,
           57,50,43,37,31,25,22,20,18,15,11,9, 8]
...
# %%
# Line curve view (with smoothing)
fig = px.line(data_frame=bio.system_snapshot(), y=["A"], 
              title= f"Diffusion. System snapshot at time t={bio.system_time}",
              color_discrete_sequence = ['red'],
              labels={"value":"concentration", "variable":"Chemical", "index":"Bin number"},
