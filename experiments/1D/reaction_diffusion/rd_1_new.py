...
# %%
bio.reaction_dynamics.is_in_equilibrium(rxn_index=0, explain=True)
...
print(f"Ratio of forward/reverse rates: {reactions.get_single_reaction(0).extract_forward_rate() / reactions.get_single_reaction(0).extract_forward_rate()}")
