...
def test_compute_reaction_rate():
    ...
    rxn = Reaction(reactants="A", products="B", kF=20., kR=2.)
    ...
    rxn = Reaction(reactants="C", products="D", kF=20., kR=2.)
    ...
    rxn = Reaction(reactants=[(2, "A", 2)], products=["B"], kF=5., kR=2.)
    ...
    rxn = Reaction(reactants=[("B")], products=[(2, "C", 2)], kF=4., kR=2.)
