...
class ReactionSimulator:
    ...
    def exact_advance_synthesis_reversible(kF, kR, A0, B0, P0, t, incremental=False) -> float:
        ...
        if np.allclose(kR, 0):
            ...
            return  ReactionSimulator.exact_advance_synthesis_irreversible(kF=kF, A0=A0, B0=B0, P0=P0, t=t, incremental=incremental)
    ...
    def half_time_to_equilibrium_irreversible_synthesis(kF, A0, B0) -> float:
        ...
        """
        #TODO: test
        #equil_concs = ReactionSimulator._compute_equilibrium_conc_first_order(kF=kF, kR=kR, a=1, A0=A0, b=1, B0=B0, p=1, P0=P0)
    ...
    def kinetic_rate_first_order(stoichiometry,
        ...
        return ReactionSimulator.compute_rate_elementary(reactants=reactants, products=products,
    ...
    def compute_equilibrium_conc_elementary_decomposition(kF, kR, A0, P0) -> dict:
        ...
        result = ReactionSimulator._compute_equilibrium_conc_first_order(kF=kF, kR=kR,
                                                                        A0=A0, a=1,
                                                                        P0=P0, Q0=P0, p=2, q=2)
    ...
    def compute_equilibrium_conc_elementary_synthesis(kF, kR, A0, P0) -> dict:
        ...
        # TODO: ditch the helper function, and do a direct computation
        result = ReactionSimulator._compute_equilibrium_conc_first_order(kF=kF, kR=kR, A0=A0, B0=A0, a=2, b=2, P0=P0, p=1)
        del result["B"]
        return result
    ...
    def compute_equilibrium_conc_mass_action(kF, kR, A0, P0, B0=None, Q0=None) -> dict:
        ...
        return ReactionSimulator._compute_equilibrium_conc_first_order(kF=kF, kR=kR, a=1, A0=A0, p=1, P0=P0, b=b, B0=B0, q=q, Q0=Q0)
